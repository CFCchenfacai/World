package com.greenish_orchid.utils;
...
public class GenEntityOracle {
    ...
    private String authorName = "cfc";// 作者名字
    private String tablename = "eb_brand";// 表名
    private String packageOutPath = "main.java.com.greenish_orchid.model";// 指定实体生成所在包的路径
...
//    private static final String PASS = "tiger";
    private static final String URL="jdbc:mysql://localhost:3306/1705ha?user=root&password=123123&useUnicode=true&characterEncoding=UTF8";
...
//            return "Date";
    ...
    public static void main(String[] args) {  
        ...
        new GenEntityOracle("movie","Movie","1705ha").init();  
        new GenEntityOracle("mbrand","Brand","1705ha").init();  
